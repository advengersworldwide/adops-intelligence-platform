...
export const clientBillingSummaryColumns: ColumnSpec[] = [
  ...
  { key: "pins", label: "PINs", required: true, aliases: ["appsflyer", "appsflyerpins", "afpins", "totalpins"], example: "1200", note: "Total PINs from any MMP (AppsFlyer, Adjust, etc.). Whole number." },
  { key: "fraudPins", label: "Fraud PINs", required: true, aliases: ["fraud"], example: "80", note: "Whole number; subtracted from PINs." },
