...
export function ClientBillingSummaryTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <TableSearch value={search} onChange={setSearch} placeholder="Search client, CPO, invoice, partner…" />
        ...
        <table className="w-full min-w-max">
          <thead>
            <tr className="border-b border-border bg-muted/30">
              ...
              <SortableTh label="CPO" sortKey="cpo" sort={sort} onSort={toggleSort} />
              <SortableTh label="Total Invoice (PKR)" sortKey="invoice" sort={sort} onSort={toggleSort} />
              <th className="px-3 py-2 text-left text-[10px] font-medium text-muted-foreground whitespace-nowrap">Paid (PKR)</th>
              <th className="px-3 py-2 text-left text-[10px] font-medium text-muted-foreground whitespace-nowrap">Pending (PKR)</th>
