...
export default function DashboardPage() {
  ...
  const [activeWidgets, setActiveWidgets] = useState(["revenue", "profit", "client-performance"]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 rounded-2xl border border-border bg-card p-5 shadow-sm">
          ...
          {timeLoading ? (
            ...
            <div className="flex h-48 items-center justify-center text-sm text-muted-foreground">No data yet. Upload transactions to see charts.</div>
          )}
        </div>
      ...
      {activeWidgets.includes("client-performance") && (
        <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
          <h2 className="mb-4 text-sm font-semibold text-foreground">Client Performance</h2>
          {clientLoading ? (
