...
export default function SettingsPage() {
  ...
  const [baseCurrency, setBaseCurrency] = useState<string>(
    () => localStorage.getItem("adops-base-currency") || "USD"
  );
  const [rateMode, setRateMode] = useState<string>(
    () => localStorage.getItem("adops-rate-mode") || "Automatic"
  );
            ...
            <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
              ...
              <div className="space-y-2.5 text-sm">
                ...
                <div className="flex justify-between py-1 border-b border-border/50">
                  ...
                  <span className="font-medium text-foreground">React + Express + PostgreSQL</span>
                </div>
